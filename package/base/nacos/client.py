...
class NacosClient:
    def __init__(self, server_addresses, service_name, namespace=None, ):
    ...
    def connect(self):
        ...
        self.client.add_naming_instance(
            self.service_name, "127.0.0.1", "5000", None, 1.0, metadata={})
        self.beat()

    def beat(self):
        self.client.send_heartbeat(self.service_name, "127.0.0.1",
                                   "5000", None, 1.0, "{}")
